        ...
        {positions.length === 0 ? (
          ...
          <div className="space-y-4">
            {positions.map((position, index) => (
              <Card
                key={`${position.asset.symbol}-${position.type}-${index}`}
              ...
              >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge
                          variant={position.type === "supply" ? "default" : "secondary"}
                ...
                <div className="mt-4 flex justify-end">
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => onManagePosition(position.asset.symbol, position.type)}
                    className="rounded-xl border-white/20 bg-white/10 backdrop-blur-sm hover:bg-white/20 dark:border-gray-700/50 dark:bg-gray-800/50"
                  >
                    Manage
                  </Button>
