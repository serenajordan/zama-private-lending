...
export default function StatCard({ icon, label, value, sublabel, trendBadge }: StatCardProps) {
  return (
    <Card className="rounded-2xl border-white/20 bg-white/10 p-6 backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-800/50">
      <div className="flex items-start justify-between">
        <div className="flex items-center space-x-3">
          <div className="rounded-xl bg-gradient-to-br from-[#6C63FF]/20 to-[#12B3C7]/20 p-2">{icon}</div>
          <div>
